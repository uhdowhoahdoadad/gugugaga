...
separatorLine.Size = UDim2.new(0, 2, 0, 289) -- Adjust size: 2px wide, same height as tabFrames
    ...
    title.Font = Enum.Font.Gotham.Bold
    title.RichText = true
    title.Text = kavName
    ...
    function Tabs.NewTab(tabName)
        ...
        coroutine.wrap(function()
            ...
            function Elements.NewButton(bname,tipINf, callback)
                ...
                btnInfo.Position = UDim2.new(0, 10, 0.272727281, 0)  -- Moved a little to the right (adjust '10' for more or less)
                btnInfo.Size = UDim2.new(1, -20, 0, 14)  -- Take almost full width but with some padding on the right
                ...
                btnInfo.TextXAlignment = Enum.TextXAlignment.Left  -- Left-aligned text
