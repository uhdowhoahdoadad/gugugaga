    ...
    function Tabs.NewTab(tabName)
        ...
        coroutine.wrap(function()
            ...
            function Elements.NewButton(bname,tipINf, callback)
                ...
                btnInfo.Position = UDim2.new(0, 0, 0.272727281, 0)  -- Align it properly to the left
                btnInfo.Size = UDim2.new(1, 0, 0, 14)  -- Take full width of the button
                ...
                btnInfo.TextXAlignment = Enum.TextXAlignment.Left  -- Ensure left alignment
